...
The current C ABI is intentionally minimal. It exposes version and time utility functions only. Full runtime, containers, save/load and callback APIs remain C++ APIs.
