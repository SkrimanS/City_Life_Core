...
- Added game profile adoption report helpers with digest, summary, scenario day-window summary and markdown output for integration-facing tooling and documentation.
...
- Added game profile catalog tests for profile lookup, support status, C ABI needs, Action Bridge usage, server-authoritative boundaries, catalog summary, catalog validation, scenario recommendations, scenario summaries, profile-specific scenario summaries, adoption reports, adoption summaries, adoption scenario day-window summaries, checklists and checklist summaries.
