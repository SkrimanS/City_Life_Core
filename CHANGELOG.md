...
- Added `examples/game_profiles.cpp` to show profile discovery, backend-service recommendations, catalog summary/markdown output, catalog validation, scenario presets, scenario summary output, adoption reports, adoption summary output, checklist digest/markdown output and checklist summary output.
- Added game profile catalog tests for profile lookup, support status, C ABI needs, Action Bridge usage, server-authoritative boundaries, catalog summary, catalog markdown output, catalog validation, scenario recommendations, scenario summaries, profile-specific scenario summaries, adoption reports, adoption report output helpers, adoption summaries, profile-specific adoption summaries, adoption scenario day-window summaries, checklists, profile-specific checklist digests, profile-specific checklist markdowns, checklist summaries and profile-specific checklist summaries.
