...
- Added game profile checklist helpers for required/optional host-side integration review steps, profile-specific checklist digest output, checklist summary counts per profile and profile-specific checklist summaries.
...
- Added game profile catalog tests for profile lookup, support status, C ABI needs, Action Bridge usage, server-authoritative boundaries, catalog summary, catalog validation, scenario recommendations, scenario summaries, profile-specific scenario summaries, adoption reports, adoption report output helpers, adoption summaries, profile-specific adoption summaries, adoption scenario day-window summaries, checklists, profile-specific checklist digests, checklist summaries and profile-specific checklist summaries.
