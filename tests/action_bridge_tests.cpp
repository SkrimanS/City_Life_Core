...
int main() {
    ...
    require(std::string_view{valid.validation_status} == clc::sim::runtime_action_status_accepted, "accepted action had wrong validation_status");
    ...
    require(std::string_view{direct.validation_status} == clc::sim::runtime_action_status_accepted, "direct RuntimeAction had wrong validation_status");
    ...
    require(std::string_view{invalid_type.validation_status} == clc::sim::runtime_action_status_invalid, "invalid action type had wrong validation_status");
    require(std::string_view{invalid_type.error_code} == clc::sim::runtime_action_error_invalid_action, "invalid action type returned wrong error_code");
    ...
    require(std::string_view{malformed.validation_status} == clc::sim::runtime_action_status_invalid, "malformed JSON had wrong validation_status");
    require(std::string_view{malformed.error_code} == clc::sim::runtime_action_error_malformed_json, "malformed JSON returned wrong error_code");
    ...
    require(std::string_view{malformed_payload.error_code} == clc::sim::runtime_action_error_malformed_json, "malformed payload returned wrong error_code");
    ...
    require(std::string_view{missing_fields.validation_status} == clc::sim::runtime_action_status_invalid, "missing fields action had wrong validation_status");
    ...
    require(std::string_view{float_amount.error_code} == clc::sim::runtime_action_error_invalid_action, "float amount returned wrong error_code");
    ...
    require(std::string_view{negative_amount.error_code} == clc::sim::runtime_action_error_invalid_action, "negative amount returned wrong error_code");
    ...
    require(std::string_view{rejected.validation_status} == clc::sim::runtime_action_status_rejected, "runtime-rejected action had wrong validation_status");
    require(std::string_view{rejected.error_code} == clc::sim::runtime_action_error_action_rejected, "runtime-rejected action returned wrong error_code");
    ...
    require(std::string_view{advance.validation_status} == clc::sim::runtime_action_status_accepted, "advance_days had wrong validation_status");
    ...
    require(std::string_view{payload_word.validation_status} == clc::sim::runtime_action_status_accepted, "payload word legacy action had wrong validation_status");
