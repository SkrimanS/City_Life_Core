...
int main() {
    ...
    require(view_string(valid.validation_status) == clc::sim::runtime_action_status_accepted, "accepted action had wrong validation_status");
    ...
    require(view_string(direct.validation_status) == clc::sim::runtime_action_status_accepted, "direct RuntimeAction had wrong validation_status");
    ...
    require(view_string(invalid_type.validation_status) == clc::sim::runtime_action_status_invalid, "invalid action type had wrong validation_status");
    require(view_string(invalid_type.error_code) == clc::sim::runtime_action_error_invalid_action, "invalid action type returned wrong error_code");
    ...
    require(view_string(malformed.validation_status) == clc::sim::runtime_action_status_invalid, "malformed JSON had wrong validation_status");
    require(view_string(malformed.error_code) == clc::sim::runtime_action_error_malformed_json, "malformed JSON returned wrong error_code");
    ...
    require(view_string(malformed_payload.error_code) == clc::sim::runtime_action_error_malformed_json, "malformed payload returned wrong error_code");
    ...
    require(view_string(missing_fields.validation_status) == clc::sim::runtime_action_status_invalid, "missing fields action had wrong validation_status");
    ...
    require(view_string(float_amount.error_code) == clc::sim::runtime_action_error_invalid_action, "float amount returned wrong error_code");
    ...
    require(view_string(rejected.validation_status) == clc::sim::runtime_action_status_rejected, "runtime-rejected action had wrong validation_status");
    require(view_string(rejected.error_code) == clc::sim::runtime_action_error_action_rejected, "runtime-rejected action returned wrong error_code");
    ...
    require(view_string(payload_word.validation_status) == clc::sim::runtime_action_status_accepted, "payload word legacy action had wrong validation_status");
