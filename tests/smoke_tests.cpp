...
int main() {
    require(clc::core_version().major == 2, "major version should be 2 for 2.0.0");
    require(clc::core_version().minor == 0, "minor version should be 0 for 2.0.0");
    require(clc::core_version().patch == 0, "patch version should be 0 for 2.0.0");
    require(clc::core_version_string() == std::string_view{"2.0.0"}, "version string should be 2.0.0");
