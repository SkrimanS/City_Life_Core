...
Validation checks descriptor ids, enum uniqueness, lookup consistency, summary count consistency, required profile fields, scenario references, scenario preset validity and checklist generation. It is intended for SDK tests, diagnostics and release review.
