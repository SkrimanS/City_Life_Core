...
Validation checks descriptor ids, enum uniqueness, lookup consistency, summary count consistency, required profile fields, system-list uniqueness, required/optional system overlap, scenario references, scenario preset validity and checklist generation. It is intended for SDK tests, diagnostics and release review.
